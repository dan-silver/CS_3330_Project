...
/**
 * "Controller" interface in ATCJ's model-view-controller structure.
 */
public interface ATCInputhandler 
{
  ...
  /**
   * When an line is entered.
   */
  public boolean processCommand( );

  /**
   * When an UI action is entered.
   * @param c   The action name.
   */
  public boolean processActionCommand( String c );

  /**
   * Forget all entered keys.
   */
  public void reset();
};
