...
public class ALTCommand extends Command
{
  ...
  public ALTCommand() { super(); alt = 0; active_flag = true; }
  public ALTCommand( int a ) { super(); alt = a; active_flag = true; }
  public ALTCommand( ALTCommand ac ) { super( (Command)ac ); alt = ac.alt; }
};
